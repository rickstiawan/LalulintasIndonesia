// simple 24x7 chart of traffic accident data from Jakarta, 2003-2012
...
var SQUARE_PADDING = 5,
    ...
    DAY_AXIS_LABELS = ['S', 'Sel', 'R', 'K', 'J', 'S', 'M'],
    HOUR_AXIS_LABELS = ['Tengah Malam', '', '', '', '', '',
                       '6 AM', '', '', '', '', '',
                       'Sore', '', '', '', '', '',
                       '6 PM', '', '', '', '', ''];
    HOUR_LABELS = ['Tengah Malam', '1 AM', '2 AM', '3 AM', '4 AM', '5 AM',
                       '6 AM', '7 AM', '8 AM', '9 AM', '10 AM', '11 AM',
                       'Sore', '1 PM', '2 PM', '3 PM', '4 PM', '5 PM',
                       '6 PM', '7 PM', '8 PM', '9 PM', '10 PM', '11 PM'];
    METRIC_LABELS = {
        'total': 'Semua Kecelakaan',
        'alcoholrelated': 'Karena alkohol',
        'fatal': 'Kecelakaan fatal',
        'pedestrian': 'Kecelakaan pejalan kaki',
        'bicycle': 'Kecelakaan sepeda',
        'motorcycle': 'Kecelakaan sepeda motor',
        'sleep': 'Pengendara mengantuk',
        'hitandrun': 'Tabrak Lari'
    };
...
// load csv formated data; originally sourced from http://www.jasamarga.com/informasi-lalulintas.html
